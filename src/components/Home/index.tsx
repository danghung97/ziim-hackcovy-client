    ...
    <div className="container" style={{width: widthScreen}}>
      <div className="introduce" style={{height: heightScreen, width: widthScreen}}>
        <div className="introduce-text">
          ...
          <p className="text1">ziim is a leading tool that help you to build your webpage and connect with your customers</p>
          <div style={{marginTop: '47px'}}>
            <p className="icon"></p>
            <a className="text3" href="https://www.google.com">Get in touch</a>
          </div>
        </div>
      </div>
      ...
      <div className="slider01">
        <div className="slider-image" style={{width: widthScreen/2 + 15, height: '510px'}}>

        </div>
        <div className="slider-text" style={{maxWidth: widthScreen/2 - 15}}>
          <span style={{marginLeft: '60px', display: 'inline-block'}}>We Have Some Awesome Courses</span>
        </div>
      </div>
      <FooterZiim/>
    </div>
